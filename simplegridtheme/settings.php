...
<tr>
  ...
  <td><input type="text" name="featured_banner_url" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_featured_banner_url',''))); ?>" /><br /><small><a href="<?php bloginfo('url'); ?>/wp-admin/media-new.php" target="_blank">Upload banner</a> (1000px wide x 100px high)</small></td>
</tr>
<!--
<tr>
